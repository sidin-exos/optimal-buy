  ...
  <View style={styles.dashboardCard}>
    ...
    <View style={styles.matrixContainer}>
      ...
      <View style={[styles.matrixRow, { borderBottomWidth: 0, backgroundColor: colors.surfaceLight }]}>
        <Text style={[styles.matrixCell, styles.matrixCellLeft, { flex: 1.5, fontWeight: 700, fontSize: 8 }]}>
          Weighted Score
        </Text>
        ...
        {matrixOptions.map((opt, i) => (
          <Text
            ...
            style={[
              styles.matrixCell,
              { fontWeight: 700, fontSize: 9, color: opt.weighted === winner.weighted ? colors.primary : colors.text },
            ]}
          >
            {opt.weighted}
          </Text>
