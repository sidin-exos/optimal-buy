...
export const scenarios: Scenario[] = [
  // Page 1 Scenarios
  {
    ...
    requiredFields: [
      ...
      { id: "recruitingCost", label: "Recruiting Cost", description: "Cost to recruit and hire new staff", type: "currency", required: false },
      { id: "managementTime", label: "Management Time", description: "Hours per month for oversight", type: "number", required: false },
      { id: "officeItPerHead", label: "Office/IT Per Head", description: "Annual office and IT costs per employee", type: "currency", required: false },
      { id: "agencyFee", label: "Agency Fee", description: "External agency or contractor fee", type: "currency", required: true },
      { id: "agencyOnboardingSpeed", label: "Agency Onboarding Speed", description: "Days to onboard external agency", type: "number", required: false },
      { id: "knowledgeRetentionRisk", label: "Knowledge Retention Risk", description: "Risk level of losing institutional knowledge", type: "select", required: false, options: ["Low", "Medium", "High"] },
      ...
      { id: "strategicImportance", label: "Strategic Importance Score", description: "How strategic is this function (1-10)", type: "number", required: false },
    ],
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "materialCost", label: "Material/Direct Cost", description: "Raw materials or direct input costs", type: "currency", required: false },
      { id: "laborCost", label: "Labor Cost", description: "Direct and indirect labor costs", type: "currency", required: false },
      { id: "overheadCost", label: "Overhead Cost", description: "Fixed and variable overhead", type: "currency", required: false },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "incidentCount", label: "Number of Incidents", description: "Quality or delivery incidents this period", type: "number", required: false },
      ...
      { id: "financialStability", label: "Financial Stability", description: "Supplier financial health", type: "select", required: false, options: ["Strong", "Moderate", "At Risk"] },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "altSuppliers", label: "Alternative Suppliers", description: "Number of backup suppliers available", type: "number", required: false },
      { id: "altProducts", label: "Substitute Products", description: "Are replacement products available?", type: "select", required: false, options: ["Yes", "No", "Partial"] },
      ...
      { id: "switchingTime", label: "Switching Time (Days)", description: "Days to switch to alternative", type: "number", required: false },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      // Industry Analysis
      { id: "marketVolatility", label: "Market Volatility", description: "How volatile is the supplier market?", type: "select", required: false, options: ["Stable", "Moderate", "Volatile", "Highly Volatile"] },
      { id: "regulatoryExposure", label: "Regulatory Exposure", description: "Level of regulatory oversight in the supply chain", type: "select", required: false, options: ["Minimal", "Moderate", "High", "Critical"] },
      { id: "geopoliticalRisk", label: "Geopolitical Risk", description: "Exposure to geopolitical instability", type: "select", required: false, options: ["Low", "Medium", "High", "Critical"] },
      ...
      { id: "contractType", label: "Contract Type", description: "Current contractual arrangement", type: "select", required: false, options: ["Spot/No Contract", "Short-term (<1yr)", "Medium-term (1-3yr)", "Long-term (3+yr)"] },
      { id: "liabilityProtection", label: "Liability Protection", description: "Level of contractual protection", type: "select", required: false, options: ["Comprehensive", "Standard", "Limited", "None"] },
      { id: "terminationRights", label: "Termination Rights", description: "Ease of contract exit", type: "select", required: false, options: ["Flexible", "Moderate Notice", "Restrictive", "Locked In"] },
      ...
      { id: "currentChallenges", label: "Current Market Challenges", description: "What specific issues are affecting this market/supplier now?", type: "textarea", required: false, placeholder: "E.g., 'Chip shortage affecting lead times. Supplier recently announced capacity expansion. Raw material prices up 15%...'" },
      { id: "supplierFinancialHealth", label: "Supplier Financial Health", description: "Current financial stability assessment", type: "select", required: false, options: ["Strong", "Stable", "Concerning", "At Risk"] },
      ...
      { id: "recoveryTime", label: "Acceptable Recovery Time", description: "Maximum tolerable disruption", type: "select", required: false, options: ["Hours", "Days", "Weeks", "Months"] },
    ],
    outputs: [
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "powerUsers", label: "Power Users", description: "Users needing full features daily", type: "number", required: false },
      { id: "regularUsers", label: "Regular Users", description: "Users needing standard features frequently", type: "number", required: false },
      { id: "occasionalUsers", label: "Occasional Users", description: "Users needing basic/view-only access occasionally", type: "number", required: false },
      ...
      { id: "implementationCost", label: "Implementation Cost", description: "One-time setup, migration, training costs", type: "currency", required: false },
      // Contract Terms
      ...
      { id: "longTermDiscount", label: "Long-Term Discount %", description: "Discount offered for multi-year commitment", type: "percentage", required: false },
      { id: "annualEscalation", label: "Annual Price Escalation %", description: "Expected or contractual annual price increase", type: "percentage", required: false },
      ...
      { id: "terminationClause", label: "Early Termination Clause", description: "Can you exit early? At what cost?", type: "select", required: false, options: ["Free Exit", "Prorated Refund", "No Refund", "Penalty Fee"] },
      // Vendor Lock-in Assessment
      { id: "dataExportability", label: "Data Exportability", description: "Ease of extracting your data", type: "select", required: false, options: ["Full Export (Standard Formats)", "Export with Limitations", "Difficult Export", "Proprietary Format Only"] },
      { id: "integrationDependency", label: "Integration Dependency", description: "How deeply integrated with other systems?", type: "select", required: false, options: ["Standalone", "Light Integration", "Moderate Integration", "Deep Integration"] },
      { id: "switchingCostEstimate", label: "Estimated Switching Cost", description: "Cost to migrate to alternative solution", type: "currency", required: false },
      { id: "alternativeProducts", label: "Viable Alternatives", description: "Number of credible alternative products", type: "select", required: false, options: ["Many (5+)", "Some (2-4)", "Few (1-2)", "None"] },
      ...
      // Strategic Factors
      { id: "vendorStability", label: "Vendor Stability", description: "Vendor's market position and financial health", type: "select", required: false, options: ["Market Leader", "Established", "Growing", "Startup/At Risk"] },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      MAIN_FOCUS_FIELD,
      { id: "legalStatus", label: "Legal Status", description: "Business registration and legal standing", type: "select", required: false, options: ["Verified", "Pending", "Issues Found"] },
      { id: "lawsuits", label: "Active Lawsuits", description: "Any pending litigation?", type: "select", required: false, options: ["None", "Minor", "Significant"] },
      ...
      { id: "financialHealth", label: "Financial Health", description: "Financial stability indicators", type: "select", required: false, options: ["Strong", "Moderate", "Weak"] },
      { id: "concentration", label: "Revenue Concentration", description: "Are we their only major client?", type: "select", required: false, options: ["Diversified", "Moderate", "Single Client"] },
      ...
      { id: "sanctionsRisk", label: "Sanctions Risk", description: "Exposure to sanctioned entities/countries", type: "select", required: false, options: ["None", "Low", "Medium", "High"] },
      { id: "cyberSecurity", label: "Cybersecurity Quality", description: "IT security maturity level", type: "select", required: false, options: ["Certified", "Adequate", "Concerning"] },
  ...
  // Page 2 Scenarios
  {
    ...
    requiredFields: [
      ...
      { id: "deliverables", label: "Deliverables", description: "List of expected outputs", type: "text", required: false },
      { id: "acceptanceCriteria", label: "Acceptance Criteria", description: "How will deliverables be accepted?", type: "text", required: false },
      { id: "timeline", label: "Timeline/Milestones", description: "Key dates and deadlines", type: "text", required: false },
      { id: "responsibilities", label: "Party Responsibilities", description: "Who does what?", type: "text", required: false },
      ...
      { id: "changeProcess", label: "Change Request Process", description: "How are changes handled?", type: "text", required: false },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "resolutionTime", label: "Resolution Time Target", description: "Expected issue resolution time", type: "text", required: false },
      { id: "allowedDowntime", label: "Allowed Downtime %", description: "Maximum acceptable downtime", type: "percentage", required: false },
      ...
      { id: "escalationProcess", label: "Escalation Process", description: "Steps when SLA is at risk", type: "text", required: false },
  ...
  },
  {
    ...
    description:
      "Paste your procurement brief or requirements and select which tender documents to generate. EXOS extracts key details automatically and produces a complete, ready-to-send tender package.",
    ...
    requiredFields: [
      ...
      MAIN_FOCUS_FIELD,
      { id: "rawBrief", label: "Procurement Brief / Raw Requirements", description: "Paste your internal brief, email thread, or requirements doc. EXOS will extract procurement subject, location, volume, deadlines, and technical specs automatically.", type: "textarea", required: true, placeholder: "Example:\n\nWe need to source a new logistics partner for our Berlin warehouse. Volume is ~500 pallets/month, mostly FMCG goods. Current contract expires June 2026. Budget is around €180k/year. Must have GDP certification and 24/7 cold chain capability. Prefer providers with existing DACH network.\n\nPaste your full brief here — the more detail, the better the output." },
      { id: "documentTypes", label: "Tender Package Documents", description: "Which documents should EXOS generate? Each type includes SMB-friendly guidance.", type: "select", required: true, options: [
      ...
      { id: "evaluationPriorities", label: "Evaluation Priorities", description: "Optional: Key scoring priorities (e.g., 'Price 40%, Quality 30%, Delivery 20%, Sustainability 10%'). If omitted, EXOS suggests balanced weights.", type: "text", required: false, placeholder: "Price 40%, Quality 30%, Delivery 20%, Sustainability 10%" },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "budget", label: "Budget Range", description: "Available funding", type: "currency", required: false },
      { id: "userCount", label: "Number of Users", description: "How many people will use this?", type: "number", required: false },
      { id: "itLandscape", label: "IT Landscape", description: "Key systems to integrate with", type: "text", required: false },
      { id: "dataSecurityLevel", label: "Data Security Requirements", description: "Sensitivity of data involved", type: "select", required: false, options: ["Public", "Internal", "Confidential", "Highly Restricted"] },
      { id: "urgency", label: "Implementation Urgency", description: "Timeline requirements", type: "select", required: false, options: ["Immediate", "3-6 Months", "6-12 Months", "Flexible"] },
  ...
  // Page 3 Scenarios
  {
    ...
    requiredFields: [
      ...
      { id: "skuOverlap", label: "SKU Overlap %", description: "Percentage of overlapping products", type: "percentage", required: false },
      { id: "unitOfMeasure", label: "Unit of Measure", description: "Standard units (kg/pcs/hours)", type: "text", required: false },
      { id: "logisticsDistance", label: "Logistics Distance", description: "Average delivery distance", type: "text", required: false },
      { id: "paymentTerms", label: "Payment Terms (DPO)", description: "Days payable outstanding", type: "number", required: false },
      { id: "orderFrequency", label: "Order Frequency", description: "How often you order", type: "select", required: false, options: ["Daily", "Weekly", "Monthly", "Quarterly"] },
      { id: "reliabilityIndex", label: "Delivery Reliability Index", description: "Supplier reliability score (1-10)", type: "number", required: false },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "maintenanceCost", label: "Annual Maintenance Cost", description: "Yearly upkeep expenses", type: "currency", required: false },
      { id: "residualValue", label: "Residual Value", description: "Asset value at end of period", type: "currency", required: false },
      { id: "propertyTax", label: "Property Tax Rate %", description: "Annual property tax", type: "percentage", required: false },
      { id: "wacc", label: "WACC/Discount Rate %", description: "Cost of capital for NPV", type: "percentage", required: false },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "inflationIndex", label: "Inflation Index %", description: "Relevant inflation rate", type: "percentage", required: false },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "lastLoginDate", label: "Last Login Date", description: "Most recent user activity", type: "text", required: false },
      { id: "featureUsage", label: "Feature Usage Score", description: "How much of the product is used (1-10)", type: "number", required: false },
      { id: "contractEndDate", label: "Contract End Date", description: "When does the subscription end?", type: "text", required: true },
      { id: "noticePeriod", label: "Notice Period (Days)", description: "Cancellation notice requirement", type: "number", required: false },
      { id: "autoRenewal", label: "Auto-Renewal", description: "Is auto-renewal enabled?", type: "select", required: false, options: ["Yes", "No"] },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "supplierCount", label: "Number of Suppliers", description: "Current supplier base size", type: "number", required: false },
      { id: "marketStructure", label: "Market Structure", description: "Competitive landscape of supplier market", type: "select", required: false, options: ["Monopoly", "Oligopoly", "Fragmented", "Emerging"] },
      { id: "supplyRisk", label: "Supply Risk Level", description: "Risk of supply disruption", type: "select", required: false, options: ["Low", "Medium", "High", "Critical"] },
      { id: "businessImpact", label: "Business Impact", description: "How critical is this category to operations?", type: "select", required: false, options: ["Low", "Medium", "High", "Strategic"] },
      { id: "currentStrategy", label: "Current Strategy", description: "Describe your existing approach to this category", type: "textarea", required: false, placeholder: "E.g., 'Multi-source with 3 approved suppliers. Annual tenders. Focus on cost reduction...'" },
      ...
      { id: "contractStatus", label: "Contract Status", description: "Current contract situation", type: "select", required: false, options: ["Active Long-term", "Expiring Soon", "Spot Buying", "Renegotiating"] },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "buyingPower", label: "Your Buying Power", description: "How important are you to this supplier?", type: "select", required: false, options: ["Top 5 Customer", "Significant", "Average", "Small Account"] },
      { id: "marketAlternatives", label: "Alternative Suppliers", description: "How many viable alternatives exist?", type: "select", required: false, options: ["None (Sole Source)", "1-2 Alternatives", "3-5 Alternatives", "Many Alternatives"] },
      { id: "switchingCost", label: "Switching Cost", description: "Cost/effort to change suppliers", type: "select", required: false, options: ["Very High", "High", "Moderate", "Low"] },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "keyInputs", label: "Key Inputs Available", description: "Resources, data, and assets available for the project", type: "textarea", required: false, placeholder: "E.g., 'Current supplier contracts, 3-year spend data, sustainability audit results, stakeholder requirements...'" },
      { id: "expectedOutputs", label: "Expected Outputs", description: "Deliverables and outcomes expected", type: "textarea", required: false, placeholder: "E.g., 'New supplier contracts, cost reduction report, sustainability certification, implementation roadmap...'" },
      { id: "budgetConstraint", label: "Budget Constraint", description: "Available project budget", type: "currency", required: false },
      { id: "timelineConstraint", label: "Timeline Constraint", description: "Project deadline or duration", type: "text", required: false },
      { id: "resourceConstraint", label: "Resource Constraints", description: "Team size, skills, availability limitations", type: "text", required: false },
      ...
      { id: "successCriteria", label: "Success Criteria", description: "How will success be measured?", type: "textarea", required: false, placeholder: "E.g., '15% cost reduction achieved, 80% sustainable materials by deadline, zero supply disruptions during transition...'" },
  ...
  // New scenarios - Pre-flight Audit, SOW Scope-Creep Detector, Exit Strategy Planner, Specification Optimizer
  {
    ...
    requiredFields: [
      ...
      { id: "plannedPurchase", label: "Planned Purchase Type", description: "What you intend to buy from this supplier", type: "text", required: false },
      ...
      { id: "existingRelationship", label: "Existing Relationship", description: "Have you worked with this supplier before?", type: "select", required: false, options: ["New Supplier", "Occasional", "Regular", "Strategic Partner"] },
      { id: "researchFocus", label: "Research Focus Areas", description: "What aspects are most important to investigate?", type: "select", required: false, options: ["Financial Health", "Legal/Litigation", "Market Reputation", "Technical Capability", "All Areas"] },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "contractType", label: "Contract Type", description: "Commercial model for this engagement", type: "select", required: false, options: ["Fixed Price", "Time & Materials", "Cost Plus", "Hybrid/Capped T&M", "Framework Agreement"] },
      { id: "contractValue", label: "Estimated Contract Value", description: "Total estimated value", type: "currency", required: true },
      // Market Intelligence Section
      { id: "marketConcentration", label: "Market Concentration", description: "How concentrated is the supplier market?", type: "select", required: false, options: ["Fragmented (many players)", "Moderate (5-10 key players)", "Oligopoly (2-4 dominant)", "Near-monopoly"] },
      { id: "marketTrends", label: "Current Market Trends", description: "Key trends affecting this category", type: "textarea", required: false, placeholder: "E.g., 'Consolidation among vendors. Skills shortage driving prices up. AI disruption changing service models...'" },
      { id: "priceVolatility", label: "Price Volatility", description: "How volatile are prices in this category?", type: "select", required: false, options: ["Stable", "Moderate fluctuation", "High volatility", "Unpredictable"] },
      { id: "supplyRisk", label: "Supply Risk Level", description: "Overall supply availability risk", type: "select", required: false, options: ["Low - ample supply", "Medium - some constraints", "High - limited suppliers", "Critical - severe constraints"] },
      // Category Dynamics
      { id: "regulatoryExposure", label: "Regulatory Exposure", description: "Level of regulatory oversight", type: "select", required: false, options: ["Minimal", "Moderate", "High", "Critical"] },
      ...
      { id: "substitutability", label: "Substitutability", description: "Ease of switching to alternatives", type: "select", required: false, options: ["Easy - many substitutes", "Moderate - some options", "Difficult - few alternatives", "Locked - no substitutes"] },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "categoryTotalSpend", label: "Total Category Spend", description: "Total spend in this category across all suppliers", type: "currency", required: false },
      // Dependency Assessment
      { id: "spendConcentration", label: "Spend Concentration", description: "What % of category spend goes to this supplier?", type: "percentage", required: false },
      { id: "revenueShare", label: "Your Share of Supplier Revenue", description: "What % of their revenue do you represent?", type: "select", required: false, options: ["<5% (small customer)", "5-15% (significant)", "15-30% (major)", ">30% (dominant)", "Unknown"] },
      ...
      { id: "uniqueCapabilities", label: "Unique Capabilities", description: "What can only this supplier provide?", type: "textarea", required: false, placeholder: "E.g., 'Proprietary technology for our core product. Only supplier with required certifications. Exclusive access to key materials...'" },
      // Lock-in Factors
      { id: "contractTerms", label: "Contract Terms", description: "Current contractual situation", type: "select", required: false, options: ["Month-to-month", "Annual renewable", "Multi-year (1-3)", "Long-term (3+)", "No contract"] },
      ...
      { id: "dataPortability", label: "Data/System Portability", description: "How easy is it to extract data/migrate systems?", type: "select", required: false, options: ["Easy - standard formats", "Moderate - some effort", "Difficult - proprietary", "Very difficult - locked in"] },
      { id: "integrationDepth", label: "Integration Depth", description: "How deeply integrated are their systems/processes?", type: "select", required: false, options: ["Surface level", "Moderate integration", "Deep integration", "Fully embedded"] },
      { id: "knowledgeDependency", label: "Knowledge Dependency", description: "Institutional knowledge held by supplier", type: "select", required: false, options: ["Low - documented", "Medium - some tacit knowledge", "High - significant expertise", "Critical - irreplaceable knowledge"] },
      // Market & Alternatives
      { id: "alternativeSuppliers", label: "Alternative Suppliers Available", description: "How many viable alternatives exist?", type: "select", required: false, options: ["Many (5+)", "Several (3-4)", "Few (2)", "Single source", "None identified"] },
      { id: "switchingTimeEstimate", label: "Estimated Switching Time", description: "Time needed to transition", type: "select", required: false, options: ["1-3 months", "3-6 months", "6-12 months", "12-24 months", ">24 months"] },
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "estimatedValue", label: "Estimated Purchase Value", description: "Budget or expected cost", type: "currency", required: false },
      { id: "specSource", label: "Specification Source", description: "Who created this specification?", type: "select", required: false, options: ["Engineering/Technical Team", "Incumbent Supplier", "Industry Standard", "Copied from Past Project", "Unknown Origin"] },
      ...
      { id: "competitiveMarket", label: "Supplier Market", description: "How many suppliers can meet current spec?", type: "select", required: false, options: ["Many (5+)", "Several (3-4)", "Few (2)", "Single Source", "Unknown"] },
  ...
  // Black Swan Scenario
  {
    ...
    requiredFields: [
      ...
      { id: "businessImpact", label: "Business Impact if Disrupted", description: "Revenue/operations impact of total failure", type: "select", required: false, options: ["Minor inconvenience", "Moderate disruption", "Significant business impact", "Catastrophic - threatens viability"] },
      // Current Risk Posture
      { id: "singleSourceItems", label: "Single-Source Dependencies", description: "How many single-source items in scope?", type: "select", required: false, options: ["None", "Few (1-3)", "Several (4-10)", "Many (10+)", "Unknown"] },
      { id: "geographicConcentration", label: "Geographic Concentration", description: "Are suppliers concentrated in specific regions?", type: "select", required: false, options: ["Globally diversified", "Multi-regional", "Single region", "Single country", "Single location"] },
      { id: "tierVisibility", label: "Supply Chain Visibility", description: "How deep can you see into sub-tiers?", type: "select", required: false, options: ["Tier 3+ visibility", "Tier 2 visibility", "Tier 1 only", "Limited visibility", "No visibility"] },
      { id: "inventoryBuffer", label: "Inventory Buffer", description: "How much safety stock do you hold?", type: "select", required: false, options: ["Months of stock", "Weeks of stock", "Days of stock", "Just-in-time/minimal", "Unknown"] },
      ...
      // Response Capability
      { id: "alternativesReady", label: "Pre-qualified Alternatives", description: "Are backup suppliers pre-qualified?", type: "select", required: false, options: ["Fully qualified and tested", "Qualified but untested", "Identified but not qualified", "None identified"] },
      { id: "responsePlaybook", label: "Crisis Response Playbook", description: "Do you have documented response plans?", type: "select", required: false, options: ["Detailed and tested", "Documented but untested", "Basic guidelines only", "None"] },
      ...
      // Risk Tolerance
      { id: "acceptableDowntime", label: "Acceptable Downtime", description: "Maximum tolerable supply disruption", type: "select", required: false, options: ["Hours", "Days", "Weeks", "Months"] },
